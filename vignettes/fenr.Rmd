...
output:
  BiocStyle::html_document:
    ...
    css: style.css
abstract: |
  With `fenr` functional data (e.g. GO-terms of KEGG pathways) can be downloaded and stored, so the functional enrichment analysis can be performed fast. The package is designed to be used with interactive applications, e.g. Shiny apps.
vignette: >
